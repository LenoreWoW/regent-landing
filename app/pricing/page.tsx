...
export default function PricingPage() {
  ...
  const faqs = [
    {
      question: 'Can I try Pro or Business features for free?',
      answer: 'Yes! Start with our Free tier and request a 14-day Pro or Business trial anytime from your dashboard. No credit card required.'
    },
    {
      question: 'How does per-seat pricing work?',
      answer: 'Business plan is charged per active seat per month. You only pay for users who are actively scheduling. Team members can be added or removed anytime.'
    },
    {
      question: 'What happens when I hit my meeting limit?',
      answer: 'On the Free plan, once you hit 20 meetings/month, you can upgrade to Pro for unlimited meetings or wait until the next month resets.'
    },
    {
      question: 'Can I downgrade my plan?',
      answer: 'Yes, you can downgrade anytime. Your plan will switch at the end of your current billing period. No refunds for partial periods.'
    },
    {
      question: 'Do you offer discounts for nonprofits?',
      answer: 'Yes! We offer 50% off for registered nonprofits and educational institutions. Contact us with proof of status to apply.'
    },
    {
      question: 'What payment methods do you accept?',
      answer: 'We accept all major credit cards (Visa, Mastercard, Amex) via Stripe. Business plans can also pay via invoice.'
    },
  ];
            ...
            {Object.entries(plans).map(([key, plan]) => (
              <div 
                ...
                className={`card text-left relative ${
                  plan.highlighted 
                    ? 'card-premium border-gold/50 scale-105 shadow-2xl' 
                    : 'card-hover'
                }`}
              >
                {plan.highlighted && (
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-gold text-charcoal text-xs font-semibold px-4 py-1 rounded-full">
                    MOST POPULAR
                  </div>
                )}
                ...
                <div className="flex items-baseline gap-1 mb-6">
                  <span className="text-4xl font-display font-medium text-charcoal">
